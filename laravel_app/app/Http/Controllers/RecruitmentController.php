...
class RecruitmentController extends Controller
{
    ...
    public function storeCandidate(Request $request): RedirectResponse
    {
        ...
        $cvFile = $request->file('FileCVUpload') ?? $request->file('cv');

        try {
            $candidateId = $this->recruitmentService->createCandidate($payload, $cvFile);
    ...
    public function applyCandidate(int $candidate): View
    {
        ...
        return view('tuyendung.apply', [
            ...
            'campaigns' => $this->recruitmentService->campaignOptions(true),
        ]);
    }
    ...
    public function attachCandidate(Request $request, int $candidate): RedirectResponse
    {
        ...
        try {
            $applicationId = $this->recruitmentService->attachCandidateToCampaign((int) $payload['MaDTD'], $candidate, $payload['GhiChu'] ?? null);
    ...
    public function updateApplicationStatus(Request $request, int $application): RedirectResponse
    {
        ...
        try {
            $this->recruitmentService->updateApplicationStatus($application, $payload);
    ...
    public function storeInterview(Request $request, int $application): RedirectResponse
    {
        ...
        try {
            $this->recruitmentService->createInterview($application, $payload);
    ...
    public function storeReview(Request $request, int $application): RedirectResponse
    {
        ...
        try {
            $this->recruitmentService->createReview($application, $payload);
    ...
    public function updateKanban(Request $request): Response
    {
        ...
        try {
            $this->recruitmentService->updateApplicationStatus((int) $payload['MaHS'], [
