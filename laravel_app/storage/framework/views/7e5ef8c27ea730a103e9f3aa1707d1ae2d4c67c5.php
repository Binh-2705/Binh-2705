...
?>
<section class="panel">
    <?php if(!$disableFilter && !$isSelfView): ?>
    <form method="get" class="filter-grid single-wide">
        ...
        <div class="button-row">
            ...
            <?php if(!$disableExport && in_array($moduleConfig['permission']['view'], session('quyen', []), true)): ?>
        ...
        <table class="data-table table-compact">
            ...
            <tbody>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="<?php echo e($columns->count() + ($hideActions ? 0 : 1)); ?>" class="muted">Không có dữ liệu.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
