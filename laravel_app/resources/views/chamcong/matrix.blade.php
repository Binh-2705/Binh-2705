...
<section class="panel">
    ...
    <div class="cc-legend" style="margin-top:12px">
        ...
        <span><span class="cc-congtac">CT</span> C = Công tác</span>
        <span><span class="cc-le">L</span> L = Nghỉ lễ</span>
        <span><span class="cc-nkl">NKL</span> N = Nghỉ KL</span>
        @if ($canCreate)
            <span style="color:#888;font-style:italic">· Bấm ô để chỉnh sửa ngay trên bảng</span>
        @endif
    </div>
</section>
